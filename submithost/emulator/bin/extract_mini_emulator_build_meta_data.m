%**********************************************************************
% matlab script: extract_mini_emulator_build_meta_data.m
%
% argument(s): datadir_,samplenumber
%
% input(s): macro_emulator.pwem  
%
% output(s): build_mini_pwem_meta.<samplenumber - formatted as %06g>
%**********************************************************************

function extract_mini_emulator_build_meta_data(datadir_,samplenumber)
